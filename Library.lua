	...
	-- elements 
		...
		function library:esp_preview(properties)
			...
			function cfg.refresh_elements( )
				...
				elseif style == "Gradient" or style == "Gradient Chams" or style == "Normal Chams" or style == "Normal Gradient Chams" then chams_color = fcolor("Chams_Grad_Color1", chams_color)
				end
